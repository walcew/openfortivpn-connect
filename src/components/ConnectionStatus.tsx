      ...
      <div className="mt-2">
        {isConnected || isBusy ? (
          <button
            ...
            className="w-full py-2.5 px-4 bg-red-500/80 hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg transition-colors"
          >
